...
const shelfBaseTitleHeight= 28;       //title height for Helvetica Light font size 28px
const shelfTitleTileOffset = 10;      //offset between title and tiles
const shelfBaseTileHeight = 180;      //shelfTile: 320x180
    ...
    return (
      <div className="App">
        <header className="App-header">
          ...
          <h1 className="App-title">FireTV HomeShelvesPane developed in React</h1>
        </header>
        ...
        <div className="HomeShelvesPane">
          ...
          <div className="homeShelvesContainer">
